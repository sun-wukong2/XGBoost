...
# Manually define hyperparameters using grid search best fit from R file
# Manually adjusted some to be more conservative and try and aleviate over fitting
params = {
    'n_estimators': 723.0,
    'x_colsample_bytree': 0.6070774303640704,
    'x_learning_rate': 0.07109942409217536, 'x_max_depth': 9.0,
    'x_reg_alpha': 0.8602343995139546,
    'x_subsample': 0.9007794293810459
}
